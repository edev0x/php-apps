# PHP Apps - Hello World

A simple `Hello World` application written in php.

### Building and running your application

When you're ready, start your application by running:
`docker compose up --build` or `docker compose up --build -d` for detached mode.
...
First, build your image, e.g.: `docker build -t hello-world .`.
